...
| **Legacy Price Oracle spec** (author Jordan Ribbink, `jribbink`) | `onflow/flow-credit-markets-old` → `docs/price-oracle.md` (`main`) | onflow org | Open (public) | ALP-era; principles still relevant | [`./legacy-design-digest.md`](./legacy-design-digest.md) Source 1 |
| **Legacy Numeraire spec** (author Tim Barry, `tim-barry`) | `onflow/flow-credit-markets-old` → `cadence/contracts/Numeraire.md` (open PR #13) | onflow org | Open (public) | ALP-era; principle still relevant | [`./legacy-design-digest.md`](./legacy-design-digest.md) Source 2 |
| **Legacy Health-Trigger-Manager spec** (author Janez Podhostnik, `janezpodhostnik`) | `onflow/flow-credit-markets-old` → `docs/health-trigger-manager.md` (open PR #12) | onflow org | Open (public) | ALP-era; closest to the current rebalancer | [`./legacy-design-digest.md`](./legacy-design-digest.md) Source 3 |
| **Legacy ALP State Mutation spec** (author Jordan Schalm, `jordanschalm`) | `onflow/flow-credit-markets-old` → `docs/flow-alp-architecture.md` (open PR #16) | onflow org | Open (public) | **Historical only** — describes removed ALP | [`./legacy-design-digest.md`](./legacy-design-digest.md) Source 4 |
